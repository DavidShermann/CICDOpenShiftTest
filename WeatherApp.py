...
def get_weather_data(cord1, cord2,cityname) -> list:
    """
    ...
    for i in range(len(time_list)):
        ...
        res_list.append({"Time": time_list[i],
...
def weather_page():
    ...
    if request.method == 'POST':
        ...
        if coords is None:
            ...
            data = get_weather_data(coords[0], coords[1],coords[2])
